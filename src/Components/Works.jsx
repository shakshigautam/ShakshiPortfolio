...
// const designs = [
//   { title: "Travel Landing Page", img: Design1 },
//   { title: "Hotel Website UI", img: Design2 },
//   { title: "Finance Dashboard", img: Design3 },
// ];
...
const projects = [
  {
    title: "SMS",
    description: "A web app for SarbatraSMS that helps users send SMS messages through the SMS portal.",
    technologies: ["React", "JavaScript", "JSX"],
    github: "https://github.com/shakshigautam/SMS",
    live: "https://sms-livid-sigma.vercel.app/",
  },
  {
    title: "Lekha Dekha",
    description: "An accounting web application built to manage financial records efficiently, with a responsive interface.",
    technologies: ["React", "JavaScript", "JSX"],
  ...
  {
    title: "Himalayan",
    description: "A tourism website created for Himalayan, a travel company, showcasing destinations and travel services.",
    technologies: ["React", "JavaScript", "JSX"],
    github: "https://github.com/shakshigautam/Himalayan",
    live: "https://himalayan-xi.vercel.app/",
  },
...
const Works = () => {
  return (
    <section id="works" className="flex flex-col items-center text-center py-24 px-6 bg-gray-50">
      ...
      {/* React Projects Section */}
      <h2 className="text-3xl font-semibold mb-8">React Projects</h2>
      <div className="grid md:grid-cols-2 gap-12 w-full max-w-6xl mb-20">
        {projects.map((project, index) => (
          <div
            key={index}
            className="bg-white p-8 rounded-xl shadow-md hover:shadow-xl transition duration-300 flex flex-col justify-between hover:scale-105"
          >
            ...
            <div className="flex flex-wrap gap-2 mb-4 text-left">
              {project.technologies.map((tech, i) => (
                <span key={i} className="text-sm bg-blue-100 text-blue-700 px-2 py-1 rounded-full">
                  {tech}
                </span>
              ))}
            </div>
      ...
      {/* Designs Section */}
      <h2 className="text-3xl font-semibold mb-8">Designs</h2>
      <div className="grid md:grid-cols-3 gap-8 w-full max-w-6xl">
        {designs.map((design, index) => (
          <div
            key={index}
            className="bg-white p-4 rounded-xl shadow-md hover:shadow-xl transition duration-300 hover:scale-105 cursor-pointer"
          >
